...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)// indica classe de teste  - - webEnvironment = WebEnvironment.RANDOM_PORT procura porta livre caso a principal esteja ocupada
